...
using Modelisateur.Modules.Designer.Controls;

namespace Modelisateur.Modules.Designer.Views
{
    /// <summary>
    ...
    public partial class GraphView : UserControl
    {
        ...
        private List<SelectableBezierLine> _selectedConnections;
        ...
        {
            InitializeComponent();
            _selectedConnections = new List<SelectableBezierLine>();
        }
        ...
        private void OnGraphControlDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(ToolboxDragDrop.DataFormat))
            {
                ...
                element.Model = ViewModel.NewElementModel();

                ViewModel.Elements.Add(element);
            }
        }

        private void OnGraphConnectionSelected(object sender, RoutedEventArgs e)
        {
            ViewModel.OnSelectionChanged();
            //SelectableBezierLine connection = (SelectableBezierLine)sender;
            //_selectedConnections.Add(connection);
        }

        private void OnGraphConnectionUnselected(object sender, RoutedEventArgs e)
        {
            ViewModel.OnSelectionChanged();
            //SelectableBezierLine connection = (SelectableBezierLine)sender;
